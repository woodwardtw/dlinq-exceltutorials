...
function excel_example_file(){
    if(get_field('example_excel_file')){
        ...
        return "<div class='col-md-4 offset-md-4'><a class='btn btn-primary btn-excel' href='{$url}'><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='#fff' class='bi bi-cloud-download' viewBox='0 0 16 16'>
